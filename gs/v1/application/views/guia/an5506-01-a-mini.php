            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <!-- Page Heading -->
                  <?php
                    $this->load->View("/partialViews/menu_guia_onu");
                  ?>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <h3>Liberação</h3>
                    <hr/>
                    <h4 id="1-acessando-pagina-de-configuracao">1 - Obtendo mac da ONU</h4>
                    <p>Abra o whatsapp e localize o endereço mac na foto enviada pelo técnico</b><p>
                    <a href="<?php echo base_url("/publico/img/onu/mac.jpg")?>">
                        <img src="<?php echo base_url("/publico/img/onu/mac.jpg")?>"/>
                    </a>
                    <br/>
                    <h4 id="1-acessando-pagina-de-configuracao">2 - Localizando OLT do cliente</h4>
                    <p>Abra o whatsapp e localize o endereço do cliente na SO enviada pelo técnico</b><p>
                    <a href="<?php echo base_url("/publico/img/onu/ordem-de-servico.jpg")?>">
                        <img src="<?php echo base_url("/publico/img/onu/ordem-de-servico.jpg")?>" style="width:480px"/>
                    </a>
