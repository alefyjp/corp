            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/roteador-tplink.jpg')?>">
                                <img src="<?php echo base_url('/publico/img/roteadores/roteador-tplink.jpg')?>" style="width:100%"/>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/roteador-tplink-2.jpg')?>" target="blank">
                                <img src="<?php echo base_url('/publico/img/roteadores/roteador-tplink-2.jpg')?>" style="width:100%"/> 
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <a class="btn btn-outline-primary" href="<?php echo base_url("/index.php/Guia/Roteadores?modelo=tl-wr849n")?>">Guia rápido</a>
                            <a class="btn btn-outline-danger" href="https://emulator.tp-link.com/Emulator_TL-WR849NV6(BR)/index.htm">Simulador</a>                         
                        </div>
                    </div>
                </div>
              </div>
