...
<head>
  ...
  <title>Roteadores - TL-WR841N</title>
  <!--*************************************************************************************
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/roteador-tplink-tlwr841n.jpg')?>">
                                <img src="<?php echo base_url('/publico/img/roteadores/roteador-tplink-tlwr841n.jpg')?>" style="width:100%"/>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/roteador-tplink-tlwr841n-2.jpg')?>" target="blank">
                                <img src="<?php echo base_url('/publico/img/roteadores/roteador-tplink-tlwr841n-2.jpg')?>" style="width:100%"/> 
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="informacoes-equipamento">
                                ...
                                <br/>
                                <br/>
                                <b>Padrões Wireless</b>
                                <br/>
                                IEEE 802.11n, IEEE 802.11g, IEEE 802.11b
                            </div> 
                            <a class="btn btn-outline-primary" href="<?php echo base_url("/index.php/Guia/Roteadores?modelo=tl-wr841n")?>">Guia rápido</a>
                            <a class="btn btn-outline-danger" href="https://emulator.tp-link.com/TL-WR841ND_V8/Index.htm">Simulador</a>                         
                        </div>
                    </div>
                </div>
              </div>
