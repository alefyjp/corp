...
<head>
  ...
  <title>Roteadores - GWR 100</title>
  <!--*************************************************************************************
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/roteador-gothan-gwr-110.jpg')?>">
                                <img src="<?php echo base_url('/publico/img/roteadores/roteador-gothan-gwr-110.jpg')?>" style="width:100%"/>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/roteador-gothan-gwr-110-2.jpg')?>" target="blank">
                                <img src="<?php echo base_url('/publico/img/roteadores/roteador-gothan-gwr-110-2.jpg')?>" style="width:100%"/> 
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="informacoes-equipamento">
                                ...
                                <br/>
                                <br/> 
                                Padrão de redeIEEE 802.11 b/g
                                <br/>
                                Velocidade de transmissãoaté 150 Mbps
                                <br/>
                                Portas4 LAN 10/100 Mbps
                                <br/>
                                Tensão/VoltagemBivolt                         
                            </div>
                            <a class="btn btn-outline-primary" href="<?php echo base_url("/index.php/Guia/Roteadores?modelo=gwr100")?>">Guia rápido</a>
                            <!-- <a class="btn btn-outline-danger" href="#">Simulador</a> -->                        
                        </div>
                    </div>
                </div>
              </div>
