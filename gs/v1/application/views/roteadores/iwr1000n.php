...
<head>
  ...
  <title>Roteadores - iwr 3000n</title>
  <!--*************************************************************************************
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/Intelbras IWR 3000N 2.jpg')?>">
                                <img src="<?php echo base_url('/publico/img/roteadores/Intelbras IWR 3000N 2.jpg')?>" style="width:100%"/>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/Intelbras IWR 3000N.jpg')?>" target="blank">
                                <img src="<?php echo base_url('/publico/img/roteadores/Intelbras IWR 3000N.jpg')?>" style="width:100%"/> 
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <a class="btn btn-outline-primary" href="<?php echo base_url("/index.php/Guia/Roteadores?modelo=iwr3000n")?>">Guia rápido</a>
                            <a class="btn btn-outline-danger disabled" href="#" disabled="disabled">Simulador</a>                         
                        </div>
                    </div>
                </div>
              </div>
