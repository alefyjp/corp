            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/roteador-tplink-tl-wr820n.jpg')?>">
                                <img src="<?php echo base_url('/publico/img/roteadores/roteador-tplink-tl-wr820n.jpg')?>" style="width:100%"/>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/roteador-tplink-tl-wr820n-2.jpg')?>" target="blank">
                                <img src="<?php echo base_url('/publico/img/roteadores/roteador-tplink-tl-wr820n-2.jpg')?>" style="width:100%"/> 
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="informacoes-equipamento">
                                ...
                                <br/>
                                <br/>
                                Fonte de energia externa: 5VDC / 0.6A
                                <br/>
                                Padrões Sem Fio: IEEE 802.11n, IEEE 802.11g, IEEE 802.11b
                                <br/>
                                Frequência: 2,412 ~ 2,472GHz
                                <br/>
                                <br/>
                                2 Portas LAN 10/100Mbps
                                <br/>
                                ...
                                <b>Taxa de sinal:</b>
                                <br/>
                                 11n: até 300Mbps (dinâmico)
                                 <br/>
                                 11g: até 54Mbps (dinâmico)
                                 <br/>
                                 11b: até 11Mbps (dinâmico)
                            </div>
                            <a class="btn btn-outline-primary" href="<?php echo base_url("/index.php/Guia/Roteadores?modelo=tl-wr820n")?>">Guia rápido</a>
                            <a class="btn btn-outline-danger" href="https://emulator.tp-link.com/WR820V1(EU)/common/Index.htm">Simulador</a>                         
                        </div>
                    </div>
                </div>
              </div>
