            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/mw301r.jpg')?>">
                                <img src="<?php echo base_url('/publico/img/roteadores/mw301r.jpg')?>" style="width:100%"/>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/roteadores/mw301r-2.jpg')?>" target="blank">
                                <img src="<?php echo base_url('/publico/img/roteadores/mw301r-2.jpg')?>" style="width:100%"/> 
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="informacoes-equipamento">
                                ...
                                Taxa de Sinal:
                                <br/>
                                - 11n: Up to 300Mbps (Dinâmico)
                                <br/>
                                - 11g: Up to 54Mbps (Dinâmico)
                                <br/>
                                - 11b: Up to 11Mbps (Dinâmico)
                            </div> 
                            <!--<a class="btn btn-outline-primary" href="<?php echo base_url("/index.php/Guia/Roteadores?modelo=tl-wr740n")?>">Guia rápido</a>-->
                            <a class="btn btn-outline-danger" target="blank" href="http://www.mercusys.com/simulator/mw301r-v2-eu/common/Index.htm" >Simulador</a>                         
                        </div>
                    </div>
                </div>
              </div>
