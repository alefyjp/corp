            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/onu/AN5506-01-A.jpg')?>">
                                <img src="<?php echo base_url('/publico/img/onu/AN5506-01-A.jpg')?>" style="width:100%"/>
                            </a>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-6">
                            <div class="informacoes-equipamento">
                                ...
                                01 porta GEPON
                                <br/>
                                Seu modo de funcionamento é em PPPOE/BRIDGE
                                <br/>
                            ...
                            <a class="btn btn-outline-primary" href="<?php echo base_url("/index.php/Guia/Onus?modelo=an5506-01-a")?>">Guia rápido</a>                                                   
                        </div>
                    </div>
                </div>
              </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                           <ul>
                              <li><a href="#">ONU apresentando led vermelho</a></li>
                              <li><a href="#">ONU não liga</a></li>
                              <li><a href="#">ONU apresenta led intermitente</a></li>
                              <li><a href="#">ONU não navega</a></li>
                              <li><a href="#">ONU apresentando lentidão</a></li>
                            </ul>
                        </div>

                        <div class="col-sm-6">
                          <ul>
                              <li><a href="#">ONU com luz alta</a></li>
                          </ul>
                        </div>
                    </div>
                </div>
