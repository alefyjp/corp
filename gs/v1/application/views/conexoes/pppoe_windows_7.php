          ...
          <div class="row">
              <div class="col-lg-12 col-lg-12">
                  <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        <li class="breadcrumb-item">CRIANDO PPPOE NO WINDOWS 7</li>
                      </ol>
                    </nav>
              </div>
          </div>      
                ...
                <div class="card-body">
                    <div class="row div-vazia">
                        <div class="col-xl-12 col-lg-12">
                            ...
                            <br/>
                            <img src="<?php echo base_url("publico/img/conexoes/ppoe_windows7_1.png")?>"/>
                            <br/>
                            <br/>
                            <p><b>Passo 2</b>. Em seguida clique em "Painel de Controle".</p>
                            <br/>
                            <img src="<?php echo base_url("publico/img/conexoes/ppoe_windows7_2.png")?>"/> 
                            <br/>
                            <br/>
                            <p><b>Passo 3</b>.  Clique agora na opção "Rede e Internet".</p>
                            <br/>
                            <img src="<?php echo base_url("publico/img/conexoes/ppoe_windows7_3.png")?>"/>
                            <br/>
                            <br/>
                            <p><b>Passo 4</b>. Em seguida escolha a opção "Centro de Rede e Compartilhamento".</p>
                            <br/>
                            <img src="<?php echo base_url("publico/img/conexoes/ppoe_windows7_4.png")?>"/>
                            <br/>
                            <br/>
                            <p><b>Passo 5</b>. No menu à direita, clique na opção "Configurar uma conexão ou uma rede nova".</p>
                            <br/>
                            <img src="<?php echo base_url("publico/img/conexoes/ppoe_windows7_5.png")?>"/>
                            <br/> 
                            <br/>  
                            <p><b>Passo 6</b>. Clique na opção de conexão "Conectar-se à Internet" e depois em "Avançar".</p>
                            <br/>
                            <img src="<?php echo base_url("publico/img/conexoes/ppoe_windows7_6.png")?>"/> 
                            <br/>
                            <br/>
                            <p><b>Passo 7</b>. Clique em "Banda larga (PPPoE)".</p>
                            <br/>
                            <img src="<?php echo base_url("publico/img/conexoes/ppoe_windows7_7.png")?>"/> 
                            <br/>
                            <br/>
                            ...
                            <br/>
                            <img src="<?php echo base_url("publico/img/conexoes/ppoe_windows7_8.png")?>"/> 
                            <br/>
                            <br/>
                            <p><b>Passo 9</b>. Aguarde enquanto o sistema estabelece a conexão e feche a tela após a conexão ser estabelecida.</p>
                            <br/>
                            <img src="<?php echo base_url("publico/img/conexoes/ppoe_windows7_9.png")?>"/> 
                            <br/>
                            <br/>                          
