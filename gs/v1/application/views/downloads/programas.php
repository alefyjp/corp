                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Winbox</td>
                                                <td><a href="<?php echo base_url('publico/Programas/winbox.exe') ?>"><i class="fas fa-download"></i></a></td>
                                            </tr>
                                            <tr>
                                                <td>ANM 2000</td>
                                                <td><a href="<?php echo base_url('publico/Programas/anm2000.exe') ?>"><i class="fas fa-download"></i></a></td>   
                                            </tr>
                                        </thead>
                                    </table>
                                </div>                       
