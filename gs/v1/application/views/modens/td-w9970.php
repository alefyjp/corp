...
<head>
  ...
  <title>Guia do Suporte - Modens</title>
  <!--*************************************************************************************
          ...
          <div class="row">
              <div class="col-lg-12 col-lg-12">
                  <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        <li class="breadcrumb-item">MODENS</li>
                      </ol>
                    </nav>
              </div>
          </div>      
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <!-- Page Heading -->
                  <?php
                    $this->load->View("/partialViews/menu_modens");
                  ?>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/modens/TD-W9970.jpg')?>">
                                <img src="<?php echo base_url('/publico/img/modens/TD-W9970.jpg')?>" style="width:100%"/>
                            </a>
                        </div>
                        <div class="col-sm-3">
                            <a href="<?php echo base_url('/publico/img/modens/TD-W9970 3.jpg')?>" target="blank">
                                <img src="<?php echo base_url('/publico/img/modens/TD-W9970 3.jpg')?>" style="width:100%"/> 
                            </a>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <a class="btn btn-outline-primary" href="<?php echo base_url("/index.php/Guia/Modens?modelo=td-w9970")?>">Guia rápido</a>
                            <a class="btn btn-outline-danger" href="https://emulator.tp-link.com/W9970V1_Emulator/index.htm">Simulador</a>                         
                        </div>
                    </div>
                </div>
              </div>
